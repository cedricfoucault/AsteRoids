...
// QCARAppControl delegate (receives callbacks in response to particular
...
@implementation QCARAppSession
@synthesize viewport;

- (id)initWithDelegate:(id<QCARAppControl>) delegate
{
    self = [super init];
    if (self) {
